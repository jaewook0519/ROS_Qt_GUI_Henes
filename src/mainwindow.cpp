...
void MainWindow::gpsCallback(const sensor_msgs::NavSatFix::ConstPtr& msg)
{
    ...
    gpsLongitudeIntegerPart = static_cast<int>(msg->longitude);
    gpsLongitudeFractionalPart = msg->longitude - gpsLongitudeIntegerPart;
}
...
void MainWindow::updateUI()
{
    ...
    ui->gpsLatitudeLabel->setText(QString::number(gpsLatitude));
    //ui->gpsLongitudeLabel->setText(QString::number(gpsLongitude));
    ui->gpsLongitudeIntegerPartLabel->setText(QString::number(gpsLongitudeIntegerPart));
    ui->gpsLongitudeFractionalPartLabel->setText(QString::number(gpsLongitudeFractionalPart));
}
