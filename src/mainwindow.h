...
//    void imageCallback2(const sensor_msgs::Image::ConstPtr& msg);
    ...
    void avoidfunctionstartCallback(const std_msgs::Bool::ConstPtr& msg);
    void avoidheadingangleCallback(const std_msgs::Float64MultiArray::ConstPtr& msg);
...
private:
    ...
    ros::Subscriber avoid_function_start_sub;
    ros::Subscriber avoid_heading_angle_sub;
    float steeringAngle;
