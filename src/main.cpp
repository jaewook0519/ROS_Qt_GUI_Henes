...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber cameraImageSub2 = nh.subscribe("/camera/depth/image_rect_raw", 1, &MainWindow::imageCallback2, &w);
    ...
    ros::Subscriber avoid_function_start_sub = nh.subscribe("avoid_function_start", 10, &MainWindow::avoidfunctionstartCallback, &w);
    ros::Subscriber avoid_heading_angle_sub = nh.subscribe("avoid_heading_angle", 10, &MainWindow::avoidheadingangleCallback, &w);
